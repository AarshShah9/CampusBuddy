...
import { createUserSchema, otpRequestSchema, otpVerifySchema, loginSchema } from '@shared/zodSchemas';
...
export const verifyOTP = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (user) {
            const token = jwt.sign(user.id, process.env.JWT_SECRET ?? "testSecret");
