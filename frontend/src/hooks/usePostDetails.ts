import { useCallback, useRef } from "react";import { BottomSheetModal, useBottomSheetModal } from "@gorhom/bottom-sheet";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { attendPost, deletePost, getLookingForById } from "~/lib/apiFunctions/LookingFor";
...
export default function usePostDetails(id: string) {
    ...
    return ({
        lookingForData, bottomSheetModalRef,
        openModal,
