    ...
    return (
        <div className="mt-8">
            <div className="flex-row flex mx-8">
                <img  className="w-auto h-96" src="\Features\EventsFeature.png"/>
                <div className="mx-4">
            ...
            <div className="flex-row flex mx-8 mt-8">
                ...
                <img  className="w-auto h-96" src="\Features\LookingForFeature.png"/>
            </div>
            <div className="flex-row flex mx-8 mt-8 mb-8">
                <img  className="w-auto h-96" src="\Features\ProfilePage.png"/>
                <div className="mx-4">
