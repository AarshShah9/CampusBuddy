...
const EventTable = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/moderation/events/`, {
        method: "GET",
        headers: {
  ...
  const handleAccept = async (id: string) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/moderation/events/approve`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        console.error("Failed to approve flagged event");
      }
    } catch (error) {
      console.error("Error updating flagged event:", error);
    }
  };
  ...
  const handleDecline = async (id: string, rejectionReason?: string) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/moderation/events/reject`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        console.error("Failed to reject flagged event");
      }
    } catch (error) {
      console.error("Error updating flagged event:", error);
    }
