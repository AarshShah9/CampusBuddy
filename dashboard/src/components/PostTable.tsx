...
const PostTable = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/moderation/posts/`, {
        method: "GET",
        headers: {
  ...
  const handleAccept = async (id: string) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/moderation/posts/approve`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        console.error("Failed to approve flagged post");
      }
    } catch (error) {
  ...
  const handleDecline = async (id: string, rejectionReason?: string) => {
    try {
      ...
      const response = await fetch(
        `${BACKEND_URL}/api/moderation/posts/reject`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        ...
        console.error("Failed to reject flagged post");
      }
    } catch (error) {
      console.error("Error updating flagged post:", error);
    }
